    ...
    >
      ...
      <div className="flex w-full items-center justify-between px-3 py-2">
        <button
          ...
          className="flex items-center gap-2 text-xs font-mono text-emerald-900/80 hover:text-emerald-900 transition-colors uppercase tracking-wider flex-1"
        >
          <span className="opacity-70 group-hover:opacity-100 transition-opacity">
            <SlidersHorizontal className="h-4 w-4" />
          </span>
          <span className="font-bold">{title}</span>
          <span className="text-[10px] text-emerald-600/60">[{totalCount}]</span>
        </button>
      ...
      {/* Content */}
      {isExpanded && (
        <div className="px-3 pb-4 pt-2 bg-emerald-50/30 animate-in slide-in-from-top-1 duration-200">

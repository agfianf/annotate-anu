    ...
    <div className="flex flex-wrap items-center gap-2 sm:gap-4 min-w-0">
      ...
      <div className="relative flex-shrink-0">
          ...
          <>
            <style>{`
              ...
              @media (prefers-reduced-motion: no-preference) {
                .anu-viewzone-border-spin { animation: border-spin 2s linear infinite; }
              }
            `}</style>
            <div className="absolute -inset-[2px] rounded-lg overflow-hidden">
              <div
                className="anu-viewzone-border-spin"
                style={{
                  position: 'absolute',
                  top: '50%',
                  left: '50%',
        ...
        <button
          ...
          className={`relative flex items-center gap-1.5 px-3 py-1.5 min-h-[32px] rounded-lg transition-all text-sm font-medium ${
            isFullView

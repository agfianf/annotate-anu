    ...
    <div className="space-y-6">
      ...
      {tasks.length === 0 ? (
        <div className="glass-strong rounded-2xl p-12 text-center shadow-lg shadow-emerald-500/5">
          ...
          <p className="text-gray-500 mb-6">Create your first task to organize jobs</p>
          <button
            onClick={() => setShowCreateModal(true)}
        ...
        <div className="space-y-3">
          {tasks.map((task) => (
            <Link
              ...
              className="glass rounded-xl p-5 shadow-lg shadow-emerald-500/5 border border-gray-100 hover:border-emerald-200 transition-all flex items-center justify-between group"
            >
              <div className="flex items-center gap-4">
